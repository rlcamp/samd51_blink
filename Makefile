...
# common
override CPPFLAGS+=-D__SKETCH_NAME__=blink -DF_CPU=120000000L -DARDUINO_ARCH_SAMD -DARDUINO_SAMD_ADAFRUIT -D__SAMD51__ -D__FPU_PRESENT -DARM_MATH_CM4 -DENABLE_CACHE -DVARIANT_QSPI_BAUD_DEFAULT=50000000 -I${PATH_CMSIS}/Core/Include/ -I${PATH_ATMEL} -I${PATH_ATMEL}/samd51/include/
